// 배민 v1.6l: post_reply 3가지 body shape 자동 시도 + replyText 검증
const fs = require('fs')
...
const FILES = [
  ['worker/src/adapters/baemin.ts', 'fix(baemin): v1.6l — post_reply 3가지 body shape 자동 시도 + replyText 진단 로그'],
  ['worker/Dockerfile',             'chore(worker): CACHE_BUST 20260505T1810 (v1.6l)'],
]
...
async function main() {
  ...
  console.log('done — v1.6l deployed')
}
