// PC/모바일 audit — 큰 모니터 가독성 max-w 추가
const fs = require('fs')
...
const FILES = [
  ['app/marketing/keyword-rank/page.tsx', 'fix(ui): max-w-[1400px] — 키워드 순위 페이지 가독성'],
  ['app/customers/page.tsx',               'fix(ui): max-w-[1400px] — 고객 관리 페이지 가독성'],
]
...
async function main() {
  ...
  console.log('done — UI audit max-w 적용')
}
