// Worker Dockerfile 강제 redeploy 트리거
const fs = require('fs')
...
async function main() {
  await pushFile(
    'worker/Dockerfile',
    'worker/Dockerfile',
    'chore(worker): bump build marker v26 → v27 (force Railway redeploy with baemin v1.6e)'
  )
  console.log('done — Dockerfile bumped, Railway should redeploy')
}
