// 배민 v1.6g_rev3: Dockerfile 전체 재작성 + 강제 재빌드
const fs = require('fs')
...
const FILES = [
  ['worker/Dockerfile',             'chore(worker): v29 aggressive rebuild — Dockerfile 전체 재작성'],
  ['worker/src/adapters/baemin.ts', 'fix(baemin): v1.6g_rev3 — VERSION_MARKER 업데이트'],
]
