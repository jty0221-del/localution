// Replace reward settings card with Quick Access card
const fs = require('fs')
...
async function pushFile(repoPath, localPath) {
  ...
  const body = { message: 'feat(qr-admin): replace reward card with Quick Access (menu/review/stamps/QR)', content: b64 }
  if (sha) body.sha = sha
