...
async function main() {
  console.log('스레드 + 대시보드 배포 시작')
  await pushFile(
    'app/marketing/threads/page.tsx',
    'app/marketing/threads/page.tsx',
    'feat(threads): Sidebar + Footer 레이아웃 통일'
  )
  await new Promise(r => setTimeout(r, 800))
  await pushFile(
    'app/dashboard/page.tsx',
    'app/dashboard/page.tsx',
    'fix(dashboard): 79차 — 별점 미수집시도 노출 + 최근리뷰 샘플 복구'
  )
  console.log('완료 — https://www.localution.co.kr/marketing/threads')
}
