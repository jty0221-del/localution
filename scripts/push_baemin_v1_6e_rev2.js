// 배민 v1.6e rev2: VERSION_MARKER 추가 + Dockerfile CACHE_BUST
const fs = require('fs')
...
const FILES = [
  ['worker/src/adapters/baemin.ts', 'fix(baemin): v1.6e_rev2 — VERSION_MARKER 로그 추가 (배포 검증용)'],
  ['worker/Dockerfile',             'chore(worker): CACHE_BUST 20260504T1430 (Railway docker layer cache 우회)'],
]
...
async function main() {
  ...
  console.log('done — Railway should rebuild fresh')
}
