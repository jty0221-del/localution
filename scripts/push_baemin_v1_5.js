// 배민 v1.5: Worker 쿠키 주입 + ERR_ABORTED 우회
const fs = require('fs')
...
async function main() {
  await pushFile(
    ...
    'worker/src/adapters/baemin.ts',
    'fix(baemin): v1.5 — Playwright 쿠키 주입으로 biz-member ERR_ABORTED 회피 + 친절한 에러 안내'
  )
  console.log('done — BAEMIN v1.5 deployed (Worker 재배포 필요)')
}
