// 배민 v1.6g: page.evaluate in-browser fetch + extractor 관대화
const fs = require('fs')
...
const FILES = [
  ['worker/src/adapters/baemin.ts', 'fix(baemin): v1.6g — page.evaluate in-browser fetch (Akamai 우회) + extractor 관대화 + 첫 item key 로그'],
  ['worker/Dockerfile',             'chore(worker): CACHE_BUST 20260505T1530 (v1.6g rebuild)'],
]
...
async function main() {
  ...
  console.log('done — v1.6g deployed')
}
