// 배민 Worker 종합 진단 + 강제 트리거 endpoint + UI 버튼
const fs = require('fs')
...
const FILES = [
  ['app/api/baemin/worker-diag/route.ts', 'feat(baemin): Worker 종합 진단 + 강제 트리거 + 30초 폴링'],
  ['app/review-admin/baemin/page.tsx',    'feat(baemin): 모달에 Worker 강제 실행 + 진단 버튼 추가'],
]
...
async function main() {
  ...
  console.log('done — Worker diag deployed')
}
