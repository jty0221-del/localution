// Dockerfile timestamp bump 으로 Railway 강제 rebuild
const fs = require('fs')
...
async function main() {
  await pushFile('worker/Dockerfile', 'worker/Dockerfile', 'chore(worker): force rebuild — v1.6j_fix syntax fix 적용 (CACHE_BUST 1730)')
  console.log('done')
}
