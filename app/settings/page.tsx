...
function NaverLogoS() {
  return (<svg width="32" height="32" viewBox="0 0 48 48" fill="none"><rect width="48" height="48" rx="10" fill="#03C75A"/><path d="M27 24.6L20.4 13.5H13.5v21H20V19.4l6.8 11.1H33.5v-21H27v15.1z" fill="white"/></svg>)
}
...
function BaeminLogoS() {
  return (<svg width="32" height="32" viewBox="0 0 48 48" fill="none"><rect width="48" height="48" rx="10" fill="#2AC1BC"/><path d="M13 15h9.8c4.14 0 6.76 2.01 6.76 5.26 0 2.1-1.2 3.76-3 4.64 2.26.76 3.76 2.56 3.76 5.1 0 3.6-2.7 6-7.5 6H13V15zm6 7.8h3c1.36 0 2.26-.76 2.26-1.96 0-1.2-.9-1.94-2.26-1.94h-3v3.9zm0 8.27h3.3c1.5 0 2.4-.76 2.4-2.1 0-1.34-.9-2.1-2.4-2.1H19v4.2z" fill="white"/></svg>)
}

function YogiyoLogoS() {
  return (<svg width="32" height="32" viewBox="0 0 48 48" fill="none"><rect width="48" height="48" rx="10" fill="#FA0050"/><text x="9" y="28" fontSize="16" fontWeight="900" fill="white" fontFamily="Arial">요기</text><text x="9" y="40" fontSize="12" fontWeight="700" fill="white" fontFamily="Arial">요</text></svg>)
}

function CoupangLogoS() {
  return (<svg width="32" height="32" viewBox="0 0 48 48" fill="none"><rect width="48" height="48" rx="10" fill="#FF4B30"/><path d="M12 17h24M12 24h18M12 31h12" stroke="white" strokeWidth="3.5" strokeLinecap="round"/></svg>)
}
...
function ConnectTab() {
  const PLATFORMS_8 = [
    ...
    { key: 'kakao', label: '카카오맵', logo: <KakaoLogoS />, desc: '카카오맵 업체 리뷰 연동', cat: '리뷰·검색' },
