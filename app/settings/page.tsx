...
function BaeminLogoS() {
  return (<svg width="32" height="32" viewBox="0 0 48 48" fill="none"><rect width="48" height="48" rx="10" fill="#2AC1BC"/><rect x="8" y="10" width="5.5" height="28" rx="2.5" fill="#1A1A1A"/><rect x="16" y="10" width="5.5" height="20" rx="2.5" fill="#1A1A1A"/><rect x="24" y="10" width="5.5" height="28" rx="2.5" fill="#1A1A1A"/><rect x="32" y="10" width="5.5" height="16" rx="2.5" fill="#1A1A1A"/><rect x="8" y="10" width="29" height="5" rx="2" fill="#1A1A1A"/></svg>)
}

function YogiyoLogoS() {
  return (<svg width="32" height="32" viewBox="0 0 48 48" fill="none"><rect width="48" height="48" rx="10" fill="#FA1A32"/><circle cx="17" cy="17" r="4.5" fill="white"/><circle cx="31" cy="17" r="4.5" fill="white"/><path d="M11 27 Q24 40 37 27" stroke="white" strokeWidth="4.5" fill="none" strokeLinecap="round"/></svg>)
}

function CoupangLogoS() {
  return (<svg width="32" height="32" viewBox="0 0 48 48" fill="none"><rect width="48" height="48" rx="10" fill="#FF5A00"/><path d="M24 7C24 7 33 14 33 24L29 28H19L15 24C15 14 24 7 24 7z" fill="white" opacity="0.95"/><circle cx="24" cy="22" r="4" fill="#FF5A00"/><path d="M19 28L17 36L24 32L31 36L29 28" fill="white" opacity="0.85"/></svg>)
}
