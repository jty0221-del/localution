...
export const metadata: Metadata = {
  ...
  description: '소상공인·자영업자 AI 마케팅 자동화. 네이버·구글 리뷰 답글, QR 리뷰, CRM, 정산 올인원.',
  keywords: [
    '로컬루션', '소상공인 마케팅', '자영업자 마케팅', '네이버 플레이스 관리',
    'AI 리뷰 답글', '리뷰 자동화', '네이버 리뷰 관리', '구글 리뷰 관리',
    'QR 리뷰', '소상공인 CRM', '고객 관리 앱', '매출 자동화',
    '카페 마케팅', '식당 마케팅', '미용실 마케팅', '학원 마케팅',
    '하랑마케팅', 'AI 마케팅 플랫폼', '네이버 SEO', '플레이스 상위노출',
  ],
  ...
  openGraph: {
    type: 'website', locale: 'ko_KR', url: BASE, siteName: '로컬루션',
    title: '로컬루션 | 소상공인·자영업자 AI 마케팅 자동화 플랫폼',
    description: '소상공인·자영업자 AI 마케팅 자동화. 네이버·구글 리뷰 답글, QR 리뷰, CRM, 정산 올인원.',
    images: [{ url: OG_IMAGE, width: 1200, height: 630, alt: '로컬루션 - 소상공인 AI 마케팅 자동화' }],
  },
  twitter: {
    card: 'summary_large_image', site: '@localution',
    title: '로컬루션 | 소상공인 AI 마케팅 자동화',
    description: '네이버·구글 리뷰 AI 답글, QR 리뷰, CRM 올인원. 월 9,900원.',
    images: [OG_IMAGE],
  },
  verification: {
    google: 'L3FR0l46_P0ajJiq4coVnEv_zvEJdnLJineApVy586Y',
    other: { 'naver-site-verification': '12af504298bf38505d03768d50aecb6da1803249' },
  },
