...
export default function ReviewPage_Kakao() {
      ...
      <main className="flex-1 md:ml-[220px] pt-14 md:pt-0">
        <div className="p-4 md:p-6 max-w-4xl mx-auto">
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h1 className="text-xl font-black text-[#191F28]">카카오 리뷰</h1>
              <p className="text-sm text-[#8B95A1] mt-0.5">총 15개 · 별점 4.7 · 미답변 2개</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-3 mb-5">
            <div className="bg-white rounded-2xl p-4 shadow-sm border border-[#F2F4F6] text-center">
              <p className="text-2xl font-black text-[#191F28]">15</p>
              <p className="text-xs text-[#8B95A1] mt-0.5">전체 리뷰</p>
            </div>
            <div className="bg-white rounded-2xl p-4 shadow-sm border border-[#F2F4F6] text-center">
              <p className="text-2xl font-black" style={{ color: '#F59E0B' }}>4.7</p>
            ...
            {REVIEWS.map((r, i) => (
              <div key={i} className="bg-white rounded-2xl shadow-sm border border-[#F2F4F6] p-5">
                ...
                {r.replied && 'reply' in r && (
                  <div className="mt-3 p-3 rounded-xl border-l-3" style={{ background: '#FFFBEB', borderLeft: '3px solid #F59E0B' }}>
                    <p className="text-xs font-semibold mb-1" style={{ color: '#F59E0B' }}>사장님 답글</p>
              ...
              <div className="bg-white rounded-2xl w-full max-w-lg shadow-2xl p-6">
                ...
                <div className="flex gap-2">
                  ...
                  <button onClick={() => setReplyModal(null)} className="flex-1 py-2.5 text-white rounded-xl text-sm font-semibold hover:opacity-90"
                    style={{ background: '#F59E0B' }}>등록하기</button>
                </div>
              </div>
            </div>
          )}
