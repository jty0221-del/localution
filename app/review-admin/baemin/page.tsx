        ...
        {!connected ? (
          ...
          <div className="max-w-lg mx-auto mt-12">
            <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
              ...
              <p className="text-sm text-[#4E5968] mb-2 leading-relaxed">배달의민족 사장님 계정으로 연동합니다. 공식 API가 없어 사장님 포털 세션 기반으로 동작합니다.</p>
              ...
              <div className="mt-4 p-4 bg-[#F8F9FA] rounded-xl text-left mb-6">
                ...
                <p className="text-xs text-[#8B95A1] font-mono">BAEMIN_OWNER_ID=...</p>
                <p className="text-xs text-[#8B95A1] font-mono">BAEMIN_OWNER_PW=...</p>
                <p className="text-[11px] text-[#8B95A1] mt-2">배민 사장님 아이디/비밀번호를 Vercel 환경변수에 추가하세요.</p>
              </div>

              <div className="flex gap-3">
                <a href="https://self.baemin.com" target="_blank" rel="noopener noreferrer"
