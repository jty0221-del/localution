  ...
  try {
    let q = svc
      ...
      .select(
        ...
        'id, platform, platform_store_id, platform_review_id, author_name, author_mask, rating, content, photos, posted_at, collected_at, has_reply, sentiment, draft_reply, reply_status, reply_tone, reply_queued_at, reply_submitted_at, reply_error, reply_attempts, raw_snapshot',
      )
      .eq('user_id', userId)
