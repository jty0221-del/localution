      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-md border-b border-gray-100 shadow-sm">
        <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-6">
            <Link href="/service-intro" className="text-sm text-[#4E5968] hover:text-[#3182F6] font-medium transition-colors">서비스 소개</Link>
            <Link href="/pricing"       className="text-sm text-[#3182F6] font-bold transition-colors border-b-2 border-[#3182F6] pb-0.5">요금</Link>
