  ...
  return (
    <div className="flex min-h-screen bg-[#F2F4F6]">
      ...
      <main className="flex-1 ml-0 md:ml-[220px] p-4 pt-20 md:p-6 md:pt-6">
        ...
        <section className="bg-gradient-to-r from-[#F97316] to-[#C2410C] text-white px-4 py-10 sm:py-14">
          <div className="max-w-5xl mx-auto flex items-center gap-4">
            <div className="text-4xl sm:text-5xl drop-shadow-sm">🎯</div>
            <div className="flex-1 min-w-0">
              <h1 className="text-xl sm:text-2xl font-black tracking-tight">키워드 스코어</h1>
              <p className="text-white/85 text-xs sm:text-sm mt-1 leading-relaxed">조회수·경쟁도·전환가치를 한 번에 — 진짜 돈 되는 키워드만</p>
            </div>
