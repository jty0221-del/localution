...
const FEATURE_GUIDES: Guide[] = [
  ...
  },
  {
    ...
    steps: [
      '정산·매출 메뉴 클릭',
      '월간 캘린더에서 일별 매출 색깔 확인 (진할수록 매출 높음)',
      '카드 / 현금 / 배달 자동 분리',
      '요일별 평균 매출로 휴무 / 영업일 결정',
    ],
    link: { href: '/settlement', label: '매출 보기 →' },
  },
]
...
const SECTIONS = [
  ...
  { id: 'review', label: '리뷰 답글', Icon: MessageSquare, color: 'from-[#F59E0B] to-[#D97706]' },
  { id: 'marketing', label: '마케팅', Icon: Megaphone, color: 'from-[#EC4899] to-[#BE185D]' },
  { id: 'qr', label: 'QR 자동화', Icon: QrCode, color: 'from-[#7C3AED] to-[#6D28D9]' },
  { id: 'customers', label: '고객 관리', Icon: Users, color: 'from-[#10B981] to-[#059669]' },
  { id: 'settlement', label: '정산·운영', Icon: Coins, color: 'from-[#22C55E] to-[#16A34A]' },
]
